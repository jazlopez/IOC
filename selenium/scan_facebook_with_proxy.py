...
def yield_profile_proxy(previous_proxy = ''):

    """
    :param previous_proxy:
    :return Proxy
    """

    PROXY = "70.99.243.11:8888"
...
try:
    ...
    # driver = webdriver.Firefox(proxy=yield_profile_proxy(None))
    ...
    for url in urls:
        ...
        try:
            ...
            driver = webdriver.Firefox(proxy=yield_profile_proxy(''))
